...
module.exports = function(){ 
  ...
  this.timing = function(path,method,time){
    ...
    gaBucket.last.pageTiming = gaBucket.last.pageTiming.timing.apply( visitor, ["request", method+" "+path, time] )
  ...
  console.error = function(msg){
    if( process.server && process.server.ga && process.server.ga.visitor )
      process.server.ga.visitor.exception(msg).send()
